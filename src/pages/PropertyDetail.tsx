    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-slate-600">The property you're looking for doesn't exist.</p>
        </div>
      </div>
    );
  }
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2">
          ...
          <div className="mb-6">
            ...
            <div className="flex items-center space-x-6 text-sm text-slate-600 mb-4">
              <div className="flex items-center bg-gradient-to-r from-teal-50 to-emerald-50 px-3 py-2 rounded-xl">
                <span className="font-medium text-teal-700">{property.type}</span>
              </div>
              {property.bedrooms > 0 && (
          ...
          <div className="mb-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
              {property.amenities.map((amenity) => (
                <div key={amenity} className="flex items-center space-x-3 p-4 bg-gradient-to-r from-orange-50 to-teal-50 rounded-xl border border-orange-100">
          ...
          {/* Stay Requirements */}
          <div className="mb-6">
            <h2 className="text-xl font-bold text-slate-900 mb-4">Stay Requirements</h2>
            <div className="bg-gradient-to-r from-slate-50 to-orange-50 rounded-xl p-6 border border-orange-200">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <p className="font-medium text-slate-900">Minimum Stay</p>
                    <p className="text-slate-600">{property.minStay} month{property.minStay > 1 ? 's' : ''}</p>
                  </div>
                </div>
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <p className="font-medium text-slate-900">Maximum Stay</p>
                    <p className="text-slate-600">{property.maxStay} month{property.maxStay > 1 ? 's' : ''}</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="lg:col-span-1">
          {/* Booking Card */}
          <div className="bg-white border border-orange-200 rounded-2xl p-6 sticky top-8 mb-6 shadow-lg">
            <div className="mb-4">
            ...
            <button
              ...
              className="w-full bg-gradient-to-r from-teal-500 to-emerald-500 text-white py-4 px-4 rounded-xl hover:from-teal-600 hover:to-emerald-600 transition-all duration-200 font-medium mb-4 shadow-lg hover:shadow-xl"
            >
              Request Booking
            </button>
          ...
          <div className="bg-white border border-orange-200 rounded-2xl p-6 shadow-lg">
            <h3 className="text-lg font-semibold text-slate-900 mb-4">Meet Your Host</h3>
            
            <div className="flex items-center space-x-4 mb-4">
              <div className="w-16 h-16 rounded-full bg-gradient-to-r from-teal-400 to-emerald-400 flex items-center justify-center shadow-lg">
                <span className="text-white text-xl font-bold">
                  {property.host.name.charAt(0)}
                </span>
              </div>
              <div>
                <h4 className="font-semibold text-slate-900">{property.host.name}</h4>
            ...
            <div className="space-y-3 mb-4">
              <div className="flex items-center space-x-3 p-3 bg-gradient-to-r from-orange-50 to-teal-50 rounded-xl">
            ...
            <div className="space-y-2">
              <button className="w-full flex items-center justify-center space-x-2 bg-gradient-to-r from-slate-100 to-orange-100 text-slate-700 py-3 px-4 rounded-xl hover:from-slate-200 hover:to-orange-200 transition-all duration-200 font-medium">
