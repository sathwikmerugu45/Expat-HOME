        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center space-x-4">
              <button className="p-2 text-slate-700 hover:text-teal-600 hover:bg-teal-50 rounded-lg transition-all duration-200">
      ...
      <footer className="bg-gradient-to-r from-slate-900 to-slate-800 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              <h3 className="font-semibold mb-4 text-orange-300">For Hosts</h3>
              <ul className="space-y-2 text-sm text-slate-400">
                <li><Link to="/admin" className="hover:text-white transition-colors">List Your Property</Link></li>
            ...
            <div>
              <h3 className="font-semibold mb-4 text-orange-300">Company</h3>
              <ul className="space-y-2 text-sm text-slate-400">
